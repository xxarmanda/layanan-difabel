...
<body>
    ...
    <nav>
        <div class="wrapper">
            ...
            <div class="menu">
                <ul>
                    <li><a href="logout"><img src="profil.png" alt=""></a></li>
    ...
    <section id="home">
        <div class="content">
            <div class="icons">
                <div class="icon"><img src="logointematrans.png" alt=""></div>
            </div>
    ...
    <section id="options">
        ...
        <div class="disability-options">
            <button onclick="window.location.href='pilihan-1'" class="btn"><img src="telinga.png" alt="">Tunarungu</button>
            <button onclick="window.location.href='pilihan2'" class="btn"><img src="tangan.PNG" alt="">Tunawicara</button>
        </div>
    </section>
